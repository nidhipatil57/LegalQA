...
import {
  ShieldAlert, Loader2, ArrowRight, Eye, EyeOff, Lock, Mail,
        ...
        <div className="hidden lg:flex lg:col-span-6 flex-col justify-between h-full pr-8">
          <div>
            ...
            <p className="text-gray-400 text-sm font-light leading-relaxed mb-10 max-w-md">
              Extract high-risk liability clauses, run semantic RAG vector queries, and compare contract revisions instantly.
            </p>

            {/* Feature Highlights Grid */}
            <div className="space-y-4 max-w-md">
              {[
                { title: 'Instant Risk Scoring', desc: 'Automated 0-100% clause risk evaluation & legal compliance flags.', icon: ShieldCheck },
                { title: 'RAG Spatial Vector Search', desc: 'Ask complex legal questions across your entire contract repository.', icon: Zap },
                { title: 'Enterprise Encryption', desc: 'SOC2 compliant data security with local tenant isolation.', icon: CheckCircle2 },
              ].map((item) => (
                <div key={item.title} className="flex items-start gap-3.5 p-3.5 rounded-2xl bg-white/[0.02] border border-white/[0.05] backdrop-blur-md">
          ...
          {/* Bottom Badge */}
          <div className="pt-10 flex items-center gap-4 text-xs text-gray-500 border-t border-white/[0.05]">
            <div className="flex -space-x-2">
              <div className="w-7 h-7 rounded-full bg-blue-600 flex items-center justify-center text-[10px] font-bold text-white border-2 border-[#070d19]">JD</div>
              <div className="w-7 h-7 rounded-full bg-indigo-600 flex items-center justify-center text-[10px] font-bold text-white border-2 border-[#070d19]">SK</div>
              <div className="w-7 h-7 rounded-full bg-purple-600 flex items-center justify-center text-[10px] font-bold text-white border-2 border-[#070d19]">AM</div>
            </div>
            <span>Trusted by 1,200+ law firms and in-house legal teams worldwide.</span>
          </div>
        </div>
          ...
          <div className="w-full max-w-md bg-[#0e1626]/80 backdrop-blur-2xl border border-white/[0.08] rounded-3xl p-8 sm:p-10 shadow-[0_20px_60px_rgba(0,0,0,0.6),0_0_40px_rgba(59,130,246,0.06)] relative overflow-hidden">
            ...
            <div className="text-center lg:text-left mb-8">
              ...
              <p className="text-xs text-gray-400 font-light">
                Enter your credentials to access your LegalQA workspace.
              </p>
            </div>

            {error && (
              <div className="mb-6 p-4 rounded-2xl bg-red-500/10 border border-red-500/20 text-red-300 text-xs flex items-start gap-3 animate-pulse">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/[0.03] border border-white/[0.08] focus:border-blue-500/60 focus:bg-white/[0.05] focus:ring-4 focus:ring-blue-500/10 text-white text-xs rounded-xl pl-11 pr-4 py-3.5 outline-none transition-all duration-300 placeholder:text-gray-600"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center">
                  ...
                  <a href="#" className="text-[11px] text-blue-400 hover:text-blue-300 transition-colors font-medium">
                    Forgot password?
                  </a>
                </div>
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••••••"
                    className="w-full bg-white/[0.03] border border-white/[0.08] focus:border-blue-500/60 focus:bg-white/[0.05] focus:ring-4 focus:ring-blue-500/10 text-white text-xs rounded-xl pl-11 pr-11 py-3.5 outline-none transition-all duration-300 placeholder:text-gray-600"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 mt-2 bg-blue-600 hover:bg-blue-500 disabled:bg-blue-600/50 text-white text-xs font-bold uppercase tracking-wider rounded-xl shadow-[0_0_30px_rgba(59,130,246,0.35)] transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer hover:scale-[1.01]"
              >
                {loading ? (
                  <>
            ...
            {/* Footer */}
            <div className="mt-8 text-center text-xs text-gray-400 font-light pt-6 border-t border-white/[0.06]">
