    ...
    <div className="relative min-h-screen text-gray-100 flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass-panel rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-sm text-gray-400 mb-8 text-center font-light">Access your premium legal intelligence workspace.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-blue-600 hover:bg-blue-500 disabled:bg-blue-600/50 text-white font-semibold rounded-xl shadow-lg shadow-blue-500/10 hover:shadow-blue-500/25 transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer hover:scale-[1.02]"
            >
              {loading ? (
                <>
          ...
          <div className="mt-8 text-center text-sm text-gray-400 font-light">
            ...
            <Link href="/signup" className="text-blue-400 hover:text-blue-300 hover:underline font-semibold transition-colors">
              Create Organization
            </Link>
          </div>
        </div>
